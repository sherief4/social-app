...
class FeedsScreen extends StatelessWidget {
    ...
    return BlocConsumer<AppCubit, AppStates>(
      listener: (context, state) {
        ...
        if (state is GetCommentsSuccessState) {
          AppCubit.get(context).getCommentsProfilePics(
            index: state.index,
            postId: state.postId,
          );
        }
        if (state is GetCommentProfilePicSuccessState) {
          showAddCommentSheet(
              context: context, index: state.index, postId: state.postId);
        }
      },
              ...
              Row(
                children: [
                  ...
                  MaterialButton(
                    ...
                    padding: EdgeInsets.zero,
                    onPressed: () {
                      AppCubit.get(context).getPostComments(
                          AppCubit.get(context).postId[index], index);
                    },
                    child: Row(
                      children: [
                        const Icon(
  ...
  void showAddCommentSheet({
    ...
    showModalBottomSheet(
      ...
      AppCubit.get(context).comments.clear();
      commentController.clear();
    });
  }
